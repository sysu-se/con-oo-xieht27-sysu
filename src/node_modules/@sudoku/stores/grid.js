...
// Domain game instance - initialized when a new game starts
let domainGame = null;
...
function createUserGrid() {
	...
	grid.subscribe($grid => {
		// Initialize domain game when grid changes (new game starts)
